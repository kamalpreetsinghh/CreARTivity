...
import { FormAndImage, FormField } from "../components";
...
const SignUpPage = () => {
  ...
  const handleConfirmPasswordChange = (updatedConfirmPassword) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      setIsLoading(true);
      const user = { name: capitalizeWords(name), email, password };
  ...
  return (
    <FormAndImage image={signup} imageDesc="Sign Up Image">
